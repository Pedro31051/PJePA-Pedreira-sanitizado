...
Uso:
    venv/bin/python teste_scrapling_movs.py 0000000-00.0000.8.10.0000
"""
import asyncio
import os
import re
...
PASTA_FIXTURES = Path(os.environ.get("PJE_LIVE_FIXTURES_DIR", "/tmp/pjepa-live-fixtures"))
...
if __name__ == "__main__":
    cnj = sys.argv[1] if len(sys.argv) > 1 else "0000000-00.0000.8.10.0000"
